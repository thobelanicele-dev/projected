  ...
  return (
    <>
      ...
      <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatTile
          label="Win rate"
          value={stats.winRate !== null ? `${stats.winRate}%` : "N/A"}
          hint="% of trades that ended in profit"
        />
        <StatTile
          label="Average result"
          value={stats.avgR !== null ? `${stats.avgR >= 0 ? "+" : ""}${stats.avgR}× risk` : "N/A"}
      ...
      <div className="mt-3 grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatTile
          ...
          value={accuracy.metOrBeatPlanRate !== null ? `${accuracy.metOrBeatPlanRate}%` : "N/A"}
        ...
        <StatTile
          ...
          value={accuracy.avgEntryDeviationPct !== null ? `${accuracy.avgEntryDeviationPct}%` : "N/A"}
